...
class QuickStatements {
	...
	public function __construct () {
        ...
        WbstackMagnusOauth::setOauthDetails(
            ...
            '/tools/quickstatements/api.php'
        );

        // We could overide where the OAuth object is created, but perhaps this config is needed by other things..
        ...
        $this->config = [
            ...
            'sites' => [
                'wikibase' => WbstackMagnusOauth::getSite('/tools/quickstatements')
            ],
        ];
